...
1) *Le faire créer un vrai projet depuis 0 genre avec npm init*
...
3) *Création d'un Dockerfile pour les projets **TD1-1**, **TD1-2**, **TD1-3** & **TD1-4***
4) *Utilisation d'un docker-compose pour déployer ces projets*
